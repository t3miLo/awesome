...
--Buttons
local shutdown = require("ui.popups.powermenu.buttons.shutdown")
local reboot = require("ui.popups.powermenu.buttons.reboot")
local logout = require("ui.popups.powermenu.buttons.logout")
local lock = require("ui.popups.powermenu.buttons.lock")
local sleep = require("ui.popups.powermenu.buttons.sleep")
