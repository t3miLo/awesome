...
local title_widget = wibox.widget {
  markup = '<span color="' ..
      color.blueish_white .. '" font="JetBrainsMono Nerd Font bold 16">' .. "Nothing Playing" .. '</span>',
  align = 'center',
  valign = 'top',
  widget = wibox.widget.textbox,
...
local artist_widget = wibox.widget {
  markup = '<span color="' ..
      color.white .. '" font="JetBrainsMono Nerd Font 14">' .. "Unknown Artist" .. '</span>',
  align = 'center',
  valign = 'bottom',
  widget = wibox.widget.textbox,
...
playerctl:connect_signal("metadata",
  function(_, title, artist, album_path, album, new, player_name)
    -- Set art widget
    if (album_path ~= nil or album_path ~= "") then
    ...
    title_widget:set_markup_silently('<span color="' ..
      color.blueish_white .. '" font="JetBrainsMono Nerd Font 8 bold">' .. title .. '</span>')
    artist_widget:set_markup_silently('<span color="' ..
      color.white .. '" font="JetBrainsMono Nerd Font 11">' .. artist .. '</span>')
  end)
...
local length_text = wibox.widget {
  markup = '<span color="' ..
      color.blueish_white .. '" font="JetBrainsMono Nerd Font 11">' .. "00:00" .. '</span>',
  align = 'center',
  valign = 'top',
  widget = wibox.widget.textbox,
  font = "JetBrainsMono Nerd Font 12",
  ...
  awful.spawn.easy_async("timeout 0.4s playerctl -F metadata -f '{{mpris:length}}'", function(stdout)
    if stdout == "" then
      ...
      length_text:set_markup_silently('<span color="' ..
        color.blueish_white .. '" font="JetBrainsMono Nerd Font 11">' .. text .. '</span>')
    else
      ...
      length_text:set_markup_silently('<span color="' ..
        color.blueish_white ..
        '" font="JetBrainsMono Nerd Font 11">' .. formattedminutes .. ':' .. formattedseconds .. '</span>')
    end
  end)
end
...
local button = wibox.widget {
  image = os.getenv("HOME") .. "/.config/awesome/ui/popups/media_player/assets/pause.png",
  resize = true,
  forced_height = dpi(40),
  forced_width = dpi(40),
  widget = wibox.widget.imagebox,
...
button:buttons(gears.table.join(
  awful.button({}, 1, function()
    ...
    if is_playing then
      if title_widget.markup == '<span color="' .. color.blueish_white .. '" font="JetBrainsMono Nerd Font bold 12">' .. "Nothing Playing" .. '</span>' then
        button:set_image(os.getenv("HOME") .. "/.config/awesome/ui/popups/media_player/assets/pause.png")
      else
        button:set_image(os.getenv("HOME") .. "/.config/awesome/ui/popups/media_player/assets/play2.png")
      end
    else
      if title_widget.markup == '<span color="' .. color.blueish_white .. '" font="JetBrainsMono Nerd Font bold 12">' .. "Nothing Playing" .. '</span>' then
        button:set_image(os.getenv("HOME") .. "/.config/awesome/ui/popups/media_player/assets/pause.png")
...
local next = wibox.widget {
  image = os.getenv("HOME") .. "/.config/awesome/ui/popups/media_player/assets/next-button.png",
  resize = true,
  forced_height = dpi(40),
  forced_width = dpi(40),
  widget = wibox.widget.imagebox,
...
local previous = wibox.widget {
  image = os.getenv("HOME") .. "/.config/awesome/ui/popups/media_player/assets/previous.png",
  resize = true,
  forced_height = dpi(40),
  forced_width = dpi(40),
  widget = wibox.widget.imagebox,
...
local forward = wibox.widget {
  image = os.getenv("HOME") .. "/.config/awesome/ui/popups/media_player/assets/15sforward.png",
  resize = true,
...
local backward = wibox.widget {
  image = os.getenv("HOME") .. "/.config/awesome/ui/popups/media_player/assets/15sbackward.png",
  resize = true,
  forced_height = dpi(45),
  forced_width = dpi(45),
  widget = wibox.widget.imagebox,
...
local media = awful.popup {
  ...
  placement = function(c)
    awful.placement.bottom_right(c,
      { margins = { top = dpi(8), bottom = dpi(50), left = dpi(8), right = dpi(8) } })
  end,
