...
local header_text = require("ui.popups.notif_center.header.header")
local header_buttons = require("ui.popups.notif_center.header.button")
    ...
    {
      {
        {
          {
            ...
            image = os.getenv("HOME") .. '/.config/awesome/ui/popups/notif_center/assets/bell.png',
            resize = true,
        ...
        Separator,
        {
          ...
          markup = '<span color="' ..
              color.blueish_white .. '" font="JetBrainsMono Nerd Font Bold 16">' .. 'NO NOTIFICATION YET' .. '</span>',
          align = "center",
          valign = "center",
